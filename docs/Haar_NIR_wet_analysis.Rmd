...
All_BT_scan_plot <- ggplot(data = full_back_trans.df %>%
                             ...
                             mutate(MRA_value = gsub(0, "Full Haar", MRA_value),
                                    ...
                                    MRA_value = gsub(4, "13% Haar", MRA_value),
                                    MRA_value = gsub(6, "4.0% Haar", MRA_value),
                                    MRA_value = gsub(7, "2.0% Haar", MRA_value),
                                    MRA_value = gsub(8, "1.0% Haar", 
                                                     MRA_value)),
  ...
  theme(legend.position = "bottom",
        ...
        axis.title = element_text(size = 13, color = "Black"),
        axis.text = element_text(size = 13, color = "Black")) +
  scale_color_grey(limits = c("Full Haar", "50% Haar", "13% Haar", "4.0% Haar",
                              "2.0% Haar", "1.0% Haar")) +
  #scale_x_reverse() +
