...
PLSR_wet <- ggplot(data = wet_perf_fig.df %>% 
  ...
  scale_y_discrete(limits = c("0.5% Haar", "1.0% Haar", "2.0% Haar", 
                              "4.0% Haar", "8.0% Haar", "15% Haar", "30% Haar",
                              "60% Haar", "Full Haar", "NIR")) +
...
ggsave("PLSR_wet_facets_20251202.png", width = 8, height = 7, 
...
ggsave("Cubist_wet_facets_20251202.png", width = 8, height = 7, 
       path = fig_dir, dpi = 300, units = "in")
...
ggsave("Wet_facets_20251118.png", width = 9, height = 9, 
       path = fig_dir, dpi = 300, units = "in")
...
tradeoff.df <- NIR_tradeoff %>%
         ...
         signal_def = ifelse(signal_compression == '0' & signal == 'Haar', 'Full Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '1', '60% Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '2', '30% Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '3', '15% Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '4', '8.0% Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '5', '4.0% Haar', 
                             signal_def),
         signal_def = ifelse(signal_compression == '6', '2.0% Haar', 
                             signal_def),
...
ggsave("NIR_tradeoff_facets_20251118.png", width = 9.5, height = 11, 
       path = fig_dir, dpi = 300, units = "in")
